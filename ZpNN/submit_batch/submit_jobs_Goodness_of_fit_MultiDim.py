...
for line in f: # -- loop over mass points 
    ...
    file_run.write("\n" + "cd " + current_dir + "\n")
    file_run.write("text2workspace.py shape_" + binning + "_" + mass_point + "_CRs.txt --X-allow-no-signal\n")
    


    file_run.write("text2workspace.py shape_" + binning + "_" + mass_point + "_CRs.txt -m 125\n")
    file_run.write("combineTool.py -M Impacts -d shape_" + binning + "_" + mass_point + "_CRs.root -m 125 --doInitialFit --robustFit 1\n")
    file_run.write("combineTool.py -M Impacts -d shape_" + binning + "_" + mass_point + "_CRs.root -m 125 --robustFit 1 --doFits\n")
    ...
    file_run.write("mv impacts.pdf /data6/Users/suoh/Limit/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/ZpNN/output/Nuisance_Impact/" + binning + "_" + mass_point + "_CRs.pdf")
