...
for line in f: # -- loop over mass points 
    ...
    file_run.write("combineTool.py -M Impacts -d shape_" + binning + "_" + mass_point + "_CRs.root -m 125 --doInitialFit --robustFit 1 -t -1 --expectSignal 1 --rMin -20\n")
    file_run.write("combineTool.py -M Impacts -d shape_" + binning + "_" + mass_point + "_CRs.root -m 125 --robustFit 1 --doFits -t -1 --expectSignal 1 --rMin -20\n")
